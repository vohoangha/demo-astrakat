            ...
            {activeTab === 'members' && (
                <div className="absolute inset-0 p-8 overflow-y-auto custom-scrollbar animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <div className="max-w-6xl mx-auto space-y-6">
                        {/* CHANGED: Solid dark background and increased z-index to fix visual bleed */}
                        <div className="bg-[#09232b] border border-[#e2b36e]/20 rounded-2xl p-4 flex items-center gap-4 shadow-[0_10px_30px_rgba(0,0,0,0.5)] sticky top-0 z-40">
